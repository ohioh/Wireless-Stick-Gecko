...
uint32_t  license[4] = {0xE8146576,0xB6760F79,0x835CA05F,0xF4613290};

/* OTAA para*/
uint8_t DevEui[] = { 0xF0, 0xA0, 0x50, 0xBD, 0x9E, 0x7c, 0x88, 0x02 };
uint8_t AppEui[] = { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };
uint8_t AppKey[] = { 0x7E, 0xF8, 0xFF, 0xE5, 0xDD, 0xEE, 0xC1, 0x09, 0x39, 0x6D, 0xCF, 0xE9, 0xE1, 0x24, 0xFA, 0xF7 };
